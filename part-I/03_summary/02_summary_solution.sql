...
SELECT ProductName, UnitPrice FROM Product ORDER BY 2;
SELECT ProductName, UnitPrice FROM Product ORDER BY 2 ASC;
...
SELECT ProductName, UnitPrice FROM Product ORDER BY 2 DESC;
...
SELECT CompanyName, Country, City FROM Customer ORDER BY Country, City;
SELECT CompanyName, Country, City FROM Customer ORDER BY Country ASC, City ASC;
SELECT CompanyName, Country, City FROM Customer ORDER BY 2, 3;
SELECT CompanyName, Country, City FROM Customer ORDER BY 2 ASC, 3 ASC;
...
SELECT CompanyName, Country, City FROM Customer ORDER BY Country, City DESC;
...
SELECT * FROM Product ORDER BY UnitPrice LIMIT 5;
